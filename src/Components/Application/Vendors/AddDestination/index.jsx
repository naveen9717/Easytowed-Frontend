...
const AddDestination = () => {
  ...
  console.log('selectedImages,files',selectedImages.length+','+files.length)
    if (files.length === selectedImages.length) {
      ...
      // console.log('updatedata',data)
          axios.post(`${process.env.REACT_APP_NODE_BACKEND_URL}/api/destination/register`, data).then((response) => {
  ...
  return (
    <Fragment>
      <Breadcrumbs parent='Destination' title='Destination Create' mainTitle='Destination Create' />
