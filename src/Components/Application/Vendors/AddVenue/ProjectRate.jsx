             ...
             <Row>
                <Col sm="6">
                    <FormGroup>
                        ...
                        <input className="form-control" type="text" name="guest_range" placeholder="Add Guest Range" {...register('guest_range')} />
                ...
                <Col sm="6">
                    <FormGroup>
                        ...
                        <input className="form-control" type="number" name="halls" placeholder="Add No of Halls" {...register('halls')} />
