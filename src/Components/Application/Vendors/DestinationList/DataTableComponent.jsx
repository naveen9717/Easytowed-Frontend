...
const DataTableComponent = () => {
    ...
    const DeleteRow = (id) => {
        ...
        axios.delete(`${process.env.REACT_APP_NODE_BACKEND_URL}/api/destination/delete/${id}`).then((response) => {
   ...
   const tableColumns = [
       {
        ...
        },
        {
            ...
            selector: row => <div className="d-flex">
                <Link to={`/destination/profile/${row.id}/`} title='Edit'><Badges attrBadge={{ color: 'primary' }} >Edit</Badges></Link>&nbsp;
