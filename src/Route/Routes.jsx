...
// //Application
import AddVenue from "../Components/Application/Vendors/AddVenue";
import VenuesList from "../Components/Application/Vendors/VenuesList";
import VenuesEdit from "../Components/Application/Vendors/VenuesEdit";
import AddPhotographer from "../Components/Application/Vendors/AddPhotographer";
...
export const routes = [
  ...
  { path: `${process.env.PUBLIC_URL}/venues-list`, Component: <VenuesList /> },
  { path: `${process.env.PUBLIC_URL}/venues/profile/:userId/`, Component: <VenuesEdit /> },
  { path: `${process.env.PUBLIC_URL}/vendors/add-venue`, Component: <AddVenue /> },
